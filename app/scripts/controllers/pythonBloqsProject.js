...
/**
 * @ngdoc function
 * @name bitbloqOffline.controller:PythonBloqsProjectCtrl
 * @description
 * # PythonBloqsProjectCtrl
 * Controller of the bitbloqOffline
 */
angular.module('bitbloqOffline')
    .controller('PythonBloqsProjectCtrl', function($scope, $rootScope, $timeout, hw2Bloqs, alertsService, commonModals, $window, $document,
        bloqsUtils, projectApi, nodeFs, common, _, $log, bloqs, pythonGeneration) {
        ...
        $scope.refreshCode = function() {
            ...
            $scope.project.code = $scope.code = pythonGeneration.getCode(bloqFullDefinition);
        };
        ...
        $scope.getCurrentProject = function() {
            ...
            if ($scope.pythonBloqs.pythonMainBloq) {
                project.software = $scope.pythonBloqs.pythonMainBloq.getBloqsStructure();
            }
            project.hardware = $scope.getHardwareSchema();

            var bloqFullDefinition = $scope.pythonBloqs.pythonMainBloq.getBloqsStructure(true);
            $scope.project.code = pythonGeneration.getCode(bloqFullDefinition);
